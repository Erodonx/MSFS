...
$id=1;
$libelle='Sushi maki';
$description='Sushis maki, un régal, saumon frais pêché de la veille ! Pêché avec amour et soin.';
$prix=8.50;
...
$description1='Du boeuf au caramel, sans prétention. un régaahjkehazhrahjkhjkakjhr';
$prix1=10.50;
$image1='boeuf_caramel.jpg'; //'boeuf-caramel-final-scaled.jpg'

$id2=3;
$libelle2='Yakitori';
$description2='Yakitori, du boeuf avec du fromage dans des belles brochettes.';
$prix2=9.00;
$image2='Yakitori.jpg'; //Yakitori-boeuf-fromage-recette-simple-et-rapide-de-brochettes-japonaises.jpg

$id3=4;
$libelle3='Riz cantonais';
$description3='Du riz cantonais, un classique quand on veux manger asiatique.';
$prix3=12.00;
...
$description4='L\'infamous burger, ce burger est extra, idéal pour les gros mangeurs et ceux qui ont envie de se faire péter la panse.';
$prix4=7.5;
...
$description5='Le classique, cheeseburger, un burger pour ceux qui ont envie de rester sur les acquis en terme de burger. Il contient des tomates de la salade et des oignons.';
$image5='hamburger_resized.jpg';

$id6=7;
$libelle6='Double beef Burger';
$description6='Le double beef burger, la viande est tellement épaisse que quand vous prenez une bouchée. Elle absorbe tout l\'espace dans la bouche, idéal pour les enfants ça les empêche de parler la bouche pleine !';
$image6='double_beef.jpg'; //Food-Name-6340.jpg

$id7=8;
$libelle7='Putin Burger';
$description7='Le Putin Burger, une bouchée de ce délicieux burger et vous êtes pris d\'une envie irrépressible d\'envahir l\'Ukraine et ainsi exhiber votre gigantesque table en marbre au monde entier';
$prixShiney=82.00;
...
$id8=9;
$libelle8='Pâte crême';
$description8='Pâtes à la crème et aux herbes, un plat subtil pour les palais affûtés, parmesan inclus a disposer soi-même.';
$image8='pasta_cat.jpg';


$id9=10;
$libelle9='Pâtes bolognaise';
$description9='Pâtes bolognaise, un classique, avec un petit ajout secret à la recette qui vous plaîra certainement.';
$image9='Bôlolo.jpeg';

$id10=11;
$libelle10='Pâtes carbonara';
$description10='Pâtes carbonara, avec de la crême onctueuse, le jaune d\'oeuf est en option si vous le souhaitez.';
$prix5=13.00;
$image10='Carbo.jpeg';

$id11=12;
$libelle11='Penne saumon';
$description11='Penne au saumon, pour ceux qui ont envie de manger des pâtes fraîches avec du bon poisson.';
$prix6=15.00;
...
$description12='Une salade césar, avec oeufs, poulet et une bonne petite vinaigrette!';
$image12='cesar_salad.jpg';

$id13=14;
$libelle13='Salade mystère';
$description13='Salades mystère, avec un ingrédient secret, pour ceux qui veulent découvrir une expérience.';
$prix7=7.50;
$image13='salad1.png';

$id14=15;
$libelle14='Salade de riz';
$description14='Salade de riz, fraiche avec du thon, idéale lors d\'une journée bien ensoleillée.';
$prix8=9.75;
$image14='Saladederiz.jpg';

$id15=16;
$libelle15='Salade de pâtes';
$description15='Une salade de pâtes fraiches, sans prétention avec quelques légumes frais du potager.';
...
$description16='Wraps au saumon, avec du fromage frais, de la bonne feta grecque.';
...
$description20='Pizza margherita, un classique qui saura stimuler vos papilles gustatives et vous plonger dans une extase profonde.';
$image20='pizza-margherita.jpg';

$libelle21='Salmonellose';
$description21='La Salmonellose, une pizza au saumon fraiche, qui saura vous combler et vous satisfaire.';
$image21='pizza-salmon.png';

$libelle22='Pizza Kebab';
$description22='Pizza kébab, un choc culturel ainsi que gustatif, un vrai régal avec une sauce kebab indémodable.';
$image22='pizzakebab.png';

$libelle23='Pizza orientale';
$description23='Pizza orientale, avec merguez et des bons légumes frais du potager ainsi que du fromage.';
