...
try {
            ...
            $stmt = $conn->prepare("INSERT INTO disc (disc_id, disc_title, disc_year, disc_picture,disc_genre,disc_label,artist_id,disc_price) VALUES (:disc_id, :disc_title, :disc_year,:disc_picture, :disc_genre,:disc_label,:artist_id,:disc_price)");
            $stmt->bindValue(':disc_id', (1+count($bite)));
