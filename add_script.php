...
try {
            ...
            $stmt->bindValue(':disc_title', $_POST['title']);
            $stmt->bindValue(':disc_year', $_POST['year']);
            $stmt->bindValue(':disc_picture', $_POST['picture']);
            $stmt->bindValue(':disc_genre', $_POST['genre']);
            $stmt->bindValue(':disc_label', $_POST['label']);
            $stmt->bindValue(':artist_id', $_POST['artist']);
            $stmt->bindValue(':disc_price', $_POST['price']);
            $stmt->execute();
